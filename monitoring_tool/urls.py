...
urlpatterns = [
    path(
        "",
        views.EmissionHome.as_view(),
        name="home"
        ),
    path("emissions/", views.EmissionList.as_view(), name="emissions"),
    path(
        "emission-checks/",
        views.EmissionCheckList.as_view(),
    ...
    path(
        'close-emission/<slug:slug>/',
        views.Emissions.close,
        name="close-emission"
        ),
    path(
        'delete-emission/<slug:slug>/',
        views.Emissions.delete,
    ...
    path(
        'delete-check/<slug:slug>/<int:id>',
        views.deleteCheck,
        name="delete-check"
        ),
    path(
        'edit-check/<slug:slug>/<int:id>',
        views.editCheck,
        name="edit-check"
        ),
]
