...
class TestEmissionCalls(TestCase):
    ...
    def setUpTestData(cls):
        """
        set up test data with cloudinary configuration, test client,
        groups, superuser and one emission.
        """
        cloudinary.config(
        ...
        username = 'test_user'
        password = 'password'
        base_user = get_user_model().objects.create_user(
            username, password=password)

        # set up admin user group - emission_admin
        admin_group = Group(name="emission_admin")
        admin_group.save()
        # solution to adding multiple permissions to group at
        # once from Stack Overflow:
        ...
        permissions = Permission.objects.filter(
            content_type__app_label='monitoring_tool',
            codename__in=permissions_names
            )
...
# https://stackoverflow.com/questions/22457557/how-to-test-login-process
    ...
    def test_login_verified_user(self):
        ...
        # How to access vars in class allowing me to access
        # the _testMethodName property.
    ...
    def test_non_verified_user(self):
        ...
        # assert that get request outside of home page returns a
        # 302 status code and redirects user to log in page.
        print(
            self._testMethodName.upper(),
    ...
    def test_adding_emission_no_perms(self):
        ...
        a 403 error indicating this operation IS NOT allowed for this
        particular user.
        """
        ...
        self.assertEqual(
            response.context['exception'],
            'You do not have the necessary permissions to add an emission. '
            'Please contact your system administrator.'
            )

    def test_adding_emission_with_perms(self):
        """
        Test admin_user with emission_admin rights trying to add an emission.
        Assert equal should confirma 200 status code indicating this operation
        IS allowed for this particular user.
        """
    ...
    def test_emission_deletion_no_perms(self):
        """
        Test admin_user trying to delete an emission.
        Assert equal should confirm a 403 status code indicating
        this operation IS NOT allowed for this particular user.
        """
    ...
    def test_emission_deletion_with_perms(self):
        """
        Test superuser trying to delete an emission. Assert equal should
        confirm a 200 status code indicating this operation IS allowed
...
class FirstMonday(TestCase):
    ...
    first_monday_of_this_month = first_monday.calculate_current_check_due()
    first_monday_of_next_month = first_monday.calculate_next_check_due()
    ...
    def test_return_datetime(self):
        ...
        self.assertEqual(
            ...
            datetime.datetime)
        self.assertEqual(
            type(self.first_monday_of_next_month),
            datetime.datetime)

    @freeze_time("1978-04-30")
    def test_first_monday_this_month(self):
        ...
        self.assertEqual(first_monday_april_78, datetime.datetime(1978, 4, 3))
    ...
    def test_first_monday_next_month(self):
        ...
        self.assertEqual(first_monday_may_78, datetime.datetime(1978, 5, 1))
