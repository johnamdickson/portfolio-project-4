...
|:-----|:------|:------|
|test_login_verified_user| Checks if verified user created in set up can log in. Performs two assertions - checks user is verified and confirms if request has been successful.|![device-testing](TESTING-files/automated-testing/python-automated-testing/spacer.png)![device-testing](TESTING-files/automated-testing/python-automated-testing/test-login-verfied.gif)![device-testing](TESTING-files/automated-testing/python-automated-testing/spacer.png)|
